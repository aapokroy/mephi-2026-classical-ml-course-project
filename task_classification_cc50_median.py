...
from src.data_utils import CC50_COLUMN, MODELS_DIR, REPORTS_DIR, ensure_dirs, feature_columns, load_data
...
def run() -> pd.DataFrame:
    ...
    target = (data[CC50_COLUMN] > data[CC50_COLUMN].median()).astype(int)
